...
кнопкой, по нажатию которой идёт сохранения данных из поля в файл</p>
    ...
    <div class="answer">
        <p>Для решения достаточно проверить получаем ли мы в массиве $_POST значения из формы, и если получаем то нужно открыть файл, произвести запись и закрыть. Для примера откроем файл с параметром w, только для записи, указатель всегда в начале.</p><br>
    </div>
    <div class=code>
    <pre>
